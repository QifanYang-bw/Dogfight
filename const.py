...
#                 [_.pos.x, _.pos.y, _.speed, _.rotation, _.accel.x, _.accel.y, _._stall]
state_upper_bar = [Right_Margin,     Top_Margin,    4, 360, 2,  2, 20, 5]
state_lower_bar = [Left_Margin - 30, Bottom_Margin, 0, 0,   0,  0,  0, 0]